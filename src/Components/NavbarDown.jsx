  ...
  return (
    ...
    <div className="navbar-container">
      <ul className="navbar-list">
        ...
        <li className="navbar-item">
          <Link to="/electronics" className="ul-link">Electronics
          <ul className="navbar-submenu">
        ...
        <li className="navbar-item">
          <Link to="/fashion" className="ul-link">Fashion
          <ul className="navbar-submenu">
        ...
        <li className="navbar-item">
          <Link to="/industrial-supplies" className="ul-link">Industrial & Professional Supplies
          <ul className="navbar-submenu">
        ...
        <li className="navbar-item red-background">
          <Link to="/precious-jewellery" className="ul-link">Precious Jewellery
          <ul className="navbar-submenu">
        ...
        <li className="navbar-item">
          <Link to="/wellness" className="ul-link">Wellness
          <ul className="navbar-submenu">
              <li className="submenu-item"><Link className="sub-link">Personal Care</Link></li>
        ...
        <li className="navbar-item">
          <Link to="/local-shops" className="ul-link">
            Local Shops
            <span className="new-badge">NEW</span>
          </Link>
        </li>
        <li className="navbar-item red-background">
          <Link to="/all-categories" className="ul-link">All Categories</Link>
        </li>
      </ul>
    </div>
  </div>
